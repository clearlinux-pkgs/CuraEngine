...
Source0  : https://github.com/Ultimaker/CuraEngine/archive/4.9.1/CuraEngine-4.9.1.tar.gz
...
%prep
%setup -q -n CuraEngine-4.9.1
cd %{_builddir}
tar xf %{_sourcedir}/e6afb9cbae4064da8c3e69af3ff5c4629579c1d2.tar.gz
cd %{_builddir}/CuraEngine-4.9.1
mkdir -p stb
cp -r %{_builddir}/stb-e6afb9cbae4064da8c3e69af3ff5c4629579c1d2/* %{_builddir}/CuraEngine-4.9.1/stb
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620750083
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/CuraEngine-4.9.1/LICENSE %{buildroot}/usr/share/package-licenses/CuraEngine/78e50e186b04c8fe1defaa098f1c192181b3d837
cp %{_builddir}/CuraEngine-4.9.1/libs/clipper/License.txt %{buildroot}/usr/share/package-licenses/CuraEngine/061a7c3bb0f292d1578ffdc1960b7b34643241da
cp %{_builddir}/CuraEngine-4.9.1/libs/rapidjson/license.txt %{buildroot}/usr/share/package-licenses/CuraEngine/491e6b20160e05471d747164c4900e5fa5c6520e
pushd clr-build
%make_install
popd
