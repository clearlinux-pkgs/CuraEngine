...
Source0  : https://github.com/Ultimaker/CuraEngine/archive/4.1.0/CuraEngine-4.1.0.tar.gz
...
%prep
%setup -q -n CuraEngine-4.1.0
cd ..
%setup -q -T -D -n CuraEngine-4.1.0 -b 1
mkdir -p stb
cp -r %{_topdir}/BUILD/stb-e6afb9cbae4064da8c3e69af3ff5c4629579c1d2/* %{_topdir}/BUILD/CuraEngine-4.1.0/stb
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563996661
mkdir -p clr-build
pushd clr-build
